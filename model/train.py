...
def train_(args):
    ...
    train_loader = DataLoader(TrafficDataset(train_data, std_mean, args.prediction_time),
                              batch_size=args.batch_size, shuffle=True, num_workers=0)
    train_len = train_data.shape[0] - 24 - int(args.prediction_time/5)
    val_loader = DataLoader(TrafficDataset(val_data, std_mean, args.prediction_time),
                            batch_size=args.batch_size, shuffle=True, num_workers=0)
